...
public class PointerEvent extends InputEvent {
	...
	public <EventType extends PointerEvent,ListenerType extends AbstractPointerEventListener<EventType>> void handlePointerEvent(ListenerType eventInterface) {
		switch(mAction) {
		case ACTION_POINTERDOWN:
			eventInterface.pointerDown(mX, mY, (EventType)this);
			break;
		case ACTION_POINTERMOVE:
			eventInterface.pointerMoved(mX, mY, (EventType)this);
			break;
		case ACTION_POINTERDRAG:
			eventInterface.pointerDragged(mX, mY, (EventType)this);
			break;	
		case ACTION_POINTERUP:
			eventInterface.pointerUp(mX, mY, (EventType)this);
			break;
		}
	}
