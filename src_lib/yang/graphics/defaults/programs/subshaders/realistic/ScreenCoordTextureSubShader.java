...
public class ScreenCoordTextureSubShader extends SubShader {
	...
	public void setVariables(ShaderPermutationsParser shaderParser, ShaderDeclarations vsDecl, ShaderDeclarations fsDecl) {
		...
		vsDecl.addUniform("vec4", "screenTexProperties");
//		shaderParser.appendLn(VAR_FS_MAIN, );
		...
		shaderParser.appendOp(VAR_FRAGCOLOR, "(1.0-screenTexCl.a)", "*");
		shaderParser.appendOp(VAR_FRAGCOLOR, "screenTexCl*screenTexCl.a", "+");
	}
