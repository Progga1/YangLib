...
public class MemorySampleState extends SampleState {
	...
	protected void draw() {
		...
		YangMatrix mat1 = mMatrixPool.alloc();
		YangMatrix mat2 = mMatrixPool.alloc();
		mat1.setTranslation(-1.2f,-0.5f);
		mGraphics2D.drawQuad(mat1);
		mMatrixPool.free(mat1);
		
		mat2.setTranslation(0.2f,0.5f);
		mat2.scale(0.2f);
		mGraphics2D.drawQuad(mat2);
		
		YangMatrix mat3 = mMatrixPool.alloc();
		...
		mMatrixPool.free(mat1);
		mMatrixPool.free(mat2);
		
		assert !mMatrixPool.isAllocated();
	}
