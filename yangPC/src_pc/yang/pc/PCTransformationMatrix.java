...
public class PCTransformationMatrix extends TransformationMatrix{
	...
	private void refreshTransform() {
		mBackMatrix.mul(mMatrix,mInterMatrix);
		Matrix4f swap = mMatrix;
		mMatrix = mBackMatrix;
		mBackMatrix = swap;
	}
	...
	public void multiplyLeft(TransformationMatrix lhsMatrix) {
		mMatrix.mul(((PCTransformationMatrix)lhsMatrix).mMatrix, mMatrix);
	}
	...
	public void asInverted(float[] target) {
		...
		mInvertedMatrix.invert();//System.out.println(mInvertedMatrix);
		for(int i=0;i<16;i++) {
