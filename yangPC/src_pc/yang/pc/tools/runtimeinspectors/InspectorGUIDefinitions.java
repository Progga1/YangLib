...
public class InspectorGUIDefinitions {
	...
	public final static Color CL_CHAIN_COMPONENT_OUTLINE_BRIGHT = new Color(130,130,130);
	public final static Color CL_CHAIN_COMPONENT_CAPTION_BACKGROUND = new Color(120,120,120);
	public final static Color CL_CHAIN_COMPONENT_CAPTION_BACKGROUND_BRIGHT = new Color(160,160,160);
	public final static Color CL_CHAIN_COMPONENT_CAPTION_FONT = new Color(250,250,250);
	...
	public static final Color CL_BAR_BACKGROUND = new Color(180,180,180);
